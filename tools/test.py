...
import pdb
from mmdet.datasets.chest import *
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='none',
        help='job launcher')
    parser.add_argument('--overwrite', action='store_true', help='overwrite test results or not?')
...
def main():
    ...
    if rank == 0:
        if args.out and args.overwrite:
            ...
            print('loading results from {}'.format(args.out))
