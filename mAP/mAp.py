...
class mAP():
    def __init__(self):
        ...
        self.gt_dir = '/home/lianjie/mmdetection-master/mAP/ground-truth/'
        self.pred_dir = '/home/lianjie/mmdetection-master/mAP/predicted/'
        self.gt_files = self.gt_dir + '*.txt'
        self.pred_files = self.pred_dir + '*.txt'
        self.tmp_files_path = '/home/lianjie/mmdetection-master/mAP/temps/'
        self.results_file_path = '/home/lianjie/mmdetection-master/mAP/test/'
        self.results_file_name = 'temp.txt'
    ...
    def get_ready(self):
        ...
        self.results_file = self.results_file_path + self.results_file_name
    ...
    def get_pred_info(self):
        ...
        for class_index, class_name in enumerate(self.gt_classes):
            ...
            for txt_file in pred_files_list:
                ...
                file_id = os.path.basename(os.path.normpath(file_id))
                if class_index == 0:
                    if not os.path.exists(self.gt_dir + file_id + ".txt"):
